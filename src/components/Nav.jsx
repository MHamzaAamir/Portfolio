...
const Nav = () => {
  ...
  return (
    <>
    <div className='nav-bg fixed bottom-14 left-[50%] text-[0.6rem] translate-x-[-50%] sm:text-sm md:text-base lg:text-lg text-white flex opacity-80 px-2 rounded-full overflow-hidden z-50'>
