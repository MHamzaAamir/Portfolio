      ...
      <div className='h-screen w-screen bg-cover bg-center text-white' >
        <div className='opacity-100 max-w-[1240px] flex flex-col  px-4 mx-auto w-[100%] h-[100%] ' >
          <div className='flex px-4 pt-4 flex-row-reverse justify-between'>
            <a target='_blank' href='https://drive.google.com/drive/folders/10OK5ke_k-Nq7udz5Ejvcd9M1G6nloKPA?usp=sharing' className='justify-self-center py-1 px-3 mt-2 border-2 border-white from-black to-purple-800 bg-gradient-to-l text-sm sm:text-lg md:text-xl '>Download CV</a>
